...
class BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(size.width / 2, -3 * size.width / 10), size.width, primaryPaint);

    primaryPaint.color = secondary;
    canvas.drawCircle(Offset(size.width * 4 / 5, size.width / 20), size.width / 4, primaryPaint);
  }
...
class CustomBackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    primaryPaint.color = secondary;
    canvas.drawCircle(
        Offset(size.width * 4.2 / 5, size.width * 0.5 / 20), size.width / 4, primaryPaint);
  }
