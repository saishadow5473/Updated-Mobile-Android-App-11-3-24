...
GetConsultantList getConsultantListFromJson(String str) =>
    GetConsultantList.fromJson(json.decode(str));

String getConsultantListToJson(GetConsultantList data) => json.encode(data.toJson());

class GetConsultantList {
  int totalCount;
  List<ConsultantList> consultantList;
  ...
  factory GetConsultantList.fromJson(Map<String, dynamic> json) => GetConsultantList(
        totalCount: json["total_count"],
        consultantList: json["ConsultantList"] != null
            ? List<ConsultantList>.from(
                json["ConsultantList"].map((x) => ConsultantList.fromJson(x)))
            : List<ConsultantList>.from(
                json["specialityList"].map((x) => ConsultantList.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "total_count": totalCount,
        "ConsultantList": List<dynamic>.from(consultantList.map((x) => x.toJson())),
      };
}
...
class ConsultantList {
  ...
  factory ConsultantList.fromJson(Map<String, dynamic> json) {
