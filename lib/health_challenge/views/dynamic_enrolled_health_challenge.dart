...
class DynamicEnrolledChallengesListScreen extends StatefulWidget {
  ...
  @override
  State<DynamicEnrolledChallengesListScreen> createState() => _DynamicEnrolledChallengesListScreenState();
}

class _DynamicEnrolledChallengesListScreenState extends State<DynamicEnrolledChallengesListScreen> {
  @override
  void initState() {
    _getData();
