...
import 'package:ihl/views/JointAccount/linked_account_setting/user_list_given_access.dart';
import 'package:ihl/views/JointAccount/linked_account_setting/user_list_with_access.dart';
import 'package:ihl/widgets/BasicPageUI.dart';
import 'package:ihl/widgets/offline_widget.dart';

class LinkedAccountSettings extends StatefulWidget {
  LinkedAccountSettings({Key key}) : super(key: key);

  @override
  _LinkedAccountSettingsState createState() => _LinkedAccountSettingsState();
}

class _LinkedAccountSettingsState extends State<LinkedAccountSettings> {
