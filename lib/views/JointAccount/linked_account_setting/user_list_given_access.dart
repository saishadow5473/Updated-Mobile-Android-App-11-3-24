...
class UserListGivenAccess extends StatefulWidget {
  UserListGivenAccess({Key key}) : super(key: key);

  @override
  _UserListGivenAccessState createState() => _UserListGivenAccessState();
}

class _UserListGivenAccessState extends State<UserListGivenAccess> {
