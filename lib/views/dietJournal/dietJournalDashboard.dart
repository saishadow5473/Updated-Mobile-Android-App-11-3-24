...
class DietJournalDashboard extends StatefulWidget {
  @override
  _DietJournalDashboardState createState() => _DietJournalDashboardState();
}

class _DietJournalDashboardState extends State<DietJournalDashboard> {
