...
Widget svgCard(BuildContext context, var _title, var _icon, var _iconSize,
        ...
        Center(
          child: Row(
            children: [
              ...
              SizedBox(
                width: ScUtil()
                    .setWidth(lessWidth.toString() == 'true' ? 10.0 : 30.0),
              ),
              Flexible(
                child: Text(
                  _title,
...
List<Consultation> consultationList = [
  Consultation(
    ...
    price: "100",
    subtitle:
        "For cardio patient here can easily contact with doctor. Can book & live chat.",
  ),
  Consultation(
    index: 2,
    title: "Diet trouble?",
    price: "80",
    subtitle:
        "For Diet troubles, you can easily contact with Dietician. Can book & live chat.",
  ),
  Consultation(
    index: 3,
  ...
  Consultation(
    ...
    price: "500",
    subtitle:
        "For General issues, you can easily contact with doctor. Can book & live chat.",
  ),
  Consultation(
    index: 5,
    title: "Therapist?",
    price: "50",
    subtitle:
        "For therapist patients, you can easily contact with doctor. Can book & live chat.",
  ),
];
      ...
      case 1:
        {
          Navigator.of(context)
              .pushNamed(Routes.SelectConsultant, arguments: list[3][0]);
        }
        break;
      case 2:
        {
          Navigator.of(context)
              .pushNamed(Routes.SelectClass, arguments: list[1][0]);
        }
        break;
      case 3:
        {
          Navigator.of(context)
              .pushNamed(Routes.SelectConsultant, arguments: list[0][1]);
        }
        break;
      case 4:
        {
          Navigator.of(context)
              .pushNamed(Routes.SelectClass, arguments: list[3][4]);
        }
        break;
      default:
        {
